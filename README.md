...
* JSON-API for stats
* New vue based UI
* Supports Ethereum Classic, Mordor, Ethereum, Ropsten, ubiq, QIE
...
### Running Pool
    ...
    ./build/bin/open-evm-pool api.json
...
```javascript
{
  ...
  "pplns": 9000,
   // mordor, classic, ethereum, ropsten or ubiq, callisto, etica, qie, ethereumPow, ethereumFair, expanse
  "network": "classic",
  ...
  "proxy": {
    ...
    */
    ...
    "policy": {
      ...
      "blacklist_file" : "/home/pool/open-evm-pool/stratum_blacklist.json",
